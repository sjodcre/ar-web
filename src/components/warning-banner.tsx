export default function WarningBanner() {
    const lastUpdated = "March 20, 2025" // Set manually
  
    return (
      <div className="flex justify-center mt-4 mb-8">
        <div className="relative overflow-hidden bg-card border border-secondary/30 px-6 py-4 rounded-lg max-w-3xl shadow-lg text-center">
          {/* Background effects */}
