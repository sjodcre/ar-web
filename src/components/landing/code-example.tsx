...
export default function CodeExample() {
  ...
  const codeExample = `// Save text data to Arweave
import Arweave from 'arweave'
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              This is an illustration only. To upload real files, check out
              <a href="https://ardrive.io/turbo-bundler/" target="_blank" rel="noopener noreferrer" className="underline ml-1">ArDrive Turbo</a>
              {" "}or use
              <a href="https://github.com/ArweaveTeam/arweave-js" target="_blank" rel="noopener noreferrer" className="underline ml-1">arweave-js</a>.
            </p>
          </div>
        </div>
        <div className="mx-auto max-w-3xl mt-8">
          <div className="rounded-lg border bg-card shadow-sm">
            <div className="flex items-center justify-between border-b px-4 py-2">
              ...
              <div className="text-sm text-muted-foreground">arweave-upload.js</div>
              <button
                onClick={copyToClipboard}
                className="rounded p-1 hover:bg-muted transition-colors"
                aria-label="Copy code"
