...
export default function StorageFeesPage() {
    ...
    return (
        <>
            {/* <Helmet>
                <title>Arweave Data Storage Fees </title>
                <meta name="description" content="The current price to store data on Arweave, as it varies with the price and demand" />

                <meta property="og:title" content="Arweave Data Storage Fees" />
                <meta property="og:description" content="The current price to store data on Arweave, as it varies with the price and demand" />
                <meta property="og:image" content="https://ar-web_arlink.arweave.net/arweave-light-seal-1200x630.png" />
                <meta property="og:url" content="https://ar-web_arlink.arweave.net/learn/fees" />
                <meta property="og:type" content="website" />

                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:image" content="https://ar-web_arlink.arweave.net/arweave-light-seal-1200x630.png" />
                <meta name="twitter:site" content="@Dev4L4fe" />
            </Helmet> */}
            <SeoHead
