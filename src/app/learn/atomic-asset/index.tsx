...
const topics = [
    {
        ...
        subtopics: [
            {
                title: "What are Atomic Assets?",
                path: "introduction/introduction-atomic-assets",
            },
            {
                title: "UDL in Depth",
                path: "introduction/udl-in-depth",
            },
        ],
    },
    {
        ...
        subtopics:[
            {
                title:"What is UCM BazAR?",
                path: "ucm-bazar/introduction-bazar"

            },
            {
                title:"Funding Wallet",
                path:"ucm-bazar/funding-wallet"
            },
            {
                title:"Creating Your Own Atomic Assets",
                path:"ucm-bazar/creating-your-own-atomic-assets"
            }
        ]
    }
];
...
const [longContent, setLongContent] = useState("");
    ...
    const contentPath = `/src/content/learn/atomic-assets/${currentSubtopic.path}`;
    ...
    //         try {
    //             const shortRes = await fetch(`/src/content/atomic-assets/${currentTopic.path}-short.md`);
    //             const longRes = await fetch(`/src/content/atomic-assets/${currentTopic.path}-long.md`);
                
    //             setShortContent(await shortRes.text());
    //             setLongContent(await longRes.text());
    //         } catch (error) {
